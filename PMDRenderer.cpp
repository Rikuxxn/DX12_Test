...
void PMDRenderer::BeforeDraw(void)
{
...
void PMDRenderer::AnimationStart(void)
{
	for (auto& actor : _actors)
	{
...
ID3D12RootSignature* PMDRenderer::RootSignature(void)
{
	return _rootSignature.Get();
}
ID3D12PipelineState* PMDRenderer::Pipeline(void)
{
	return _pls.Get();
}

bool PMDRenderer::CreateRootSignature(void) 
{
...
bool PMDRenderer::CreatePipeline(void)
{
