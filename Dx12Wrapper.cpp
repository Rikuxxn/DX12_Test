...
bool Dx12Wrapper::CreatePeraVertex(void)
{
	struct PeraVertex
	{
		XMFLOAT3 pos;
...
ComPtr<ID3D12Resource> Dx12Wrapper::WhiteTexture(void) 
{
	return _whiteTex;
}
ComPtr<ID3D12Resource> Dx12Wrapper::BlackTexture(void)
{
	return _blackTex;
}
ComPtr<ID3D12Resource> Dx12Wrapper::GradTexture(void)
{
	return _gradTex;
}

bool Dx12Wrapper::CreateRenderTargetView(void)
{
	DXGI_SWAP_CHAIN_DESC1 swDesc = {};
...
bool Dx12Wrapper::CreateCommandList(void)
{
...
void Dx12Wrapper::PostDrawToPera1(void) 
{
...
bool Dx12Wrapper::PreDrawToPera1(void) 
{
	auto barrier = CD3DX12_RESOURCE_BARRIER::Transition(_peraResource.Get(),
		D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE,
		D3D12_RESOURCE_STATE_RENDER_TARGET);
...
bool Dx12Wrapper::CreateDepthBuffer(void)
{
...
bool Dx12Wrapper::CreateDSV(void)
{
	D3D12_DESCRIPTOR_HEAP_DESC desc = {};
	desc.NodeMask = 0;
...
bool Dx12Wrapper::CreatePeraPipeline(void)
{
...
void Dx12Wrapper::DrawHorizontalBokeh(void)
{//横ボケ画像を描画する
...
void Dx12Wrapper::SetCameraSetting(void)
{
	auto wsize = Application::Instance().GetWindowSize();
...
bool Dx12Wrapper::CreateWhiteTexture(void)
{
	D3D12_HEAP_PROPERTIES heapprop = {};
	heapprop.Type = D3D12_HEAP_TYPE_CUSTOM;//テクスチャ用
	heapprop.MemoryPoolPreference = D3D12_MEMORY_POOL_L0;
...
bool Dx12Wrapper::CreateBlackTexture(void) 
{
	D3D12_HEAP_PROPERTIES heapprop = {};
	heapprop.Type = D3D12_HEAP_TYPE_CUSTOM;//テクスチャ用
	heapprop.MemoryPoolPreference = D3D12_MEMORY_POOL_L0;
...
bool Dx12Wrapper::CreateGradationTexture(void)
{
	D3D12_HEAP_PROPERTIES heapprop = {};
	heapprop.Type = D3D12_HEAP_TYPE_CUSTOM;//テクスチャ用
	heapprop.MemoryPoolPreference = D3D12_MEMORY_POOL_L0;
...
XMVECTOR Dx12Wrapper::GetCameraPosition(void)
{
	return XMLoadFloat3(&_eye);
}

bool Dx12Wrapper::CreateBokehParamResource(void)
{
...
bool Dx12Wrapper::LoadPictureFromFile(wstring filepath, ComPtr<ID3D12Resource>& buff)
{
...
bool Dx12Wrapper::CreateTransformConstantBuffer(void)
{
	D3D12_HEAP_PROPERTIES heapProp = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);
...
bool Dx12Wrapper::CreateTransformBufferView(void)
{
	//定数バッファビューの作成
	D3D12_DESCRIPTOR_HEAP_DESC heapDesc = {};
	heapDesc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE;
...
bool Dx12Wrapper::CreatePeraResourcesAndView(void)
{
